...
export function LaborBookingForm() {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      sharedNote: "",
      laborDetails: [
        { date: getLocalDate(), timeSlot: "7:30 AM - 11:30 AM", note: "" },
      ],
    },
  });
        ...
        <CardContent className="p-6">
          {bookingSuccess ? (
            <div className="text-center">
              ...
              <p className="mb-6">
                Your labor booking has been submitted successfully.
              </p>
              <Button
                onClick={() => {
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Select
                              ...
                              <SelectTrigger>
                                <SelectValue
                                  placeholder={user.zipcode || "Select zipcode"}
                                />
                              </SelectTrigger>
                              <SelectContent>
                                {zipcodes.length > 0 ? (
                          ...
                          <div className="text-sm text-muted-foreground flex items-center gap-2">
                            {zipcodes.length === 0 ? (
                              ...
                              `${
                                zipcodes.length
                              } zipcodes available for ${form.watch("city")}`
                            )}
                          </div>
                          <FormMessage />
                        </FormItem>
