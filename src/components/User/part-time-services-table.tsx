    ...
    cell: ({ row }) => {
      ...
      const handleAcceptOffer = async () => {
        try {
          ...
          // Implement a refresh function here
        } catch (error) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setError("Failed to fetch user part-time bookings. Please try again.")
      } finally {
        setIsLoading(false)
      }
    }
    ...
    <div className="w-full">
      ...
      {!isLoading && !error && (
        <Button
          onClick={() => {
            setIsLoading(true)
            // Implement a refresh function here -  This would ideally call fetchData again.
            const fetchData = async () => {
              try {
                const response = await getUserPartimeBookings();
                setData(response)
