...
export default function UserSubscription() {
  const [subscription, setSubscription] = useState<UserSubscription>({
    plan: demoUser.user_role as SubscriptionPlan,
    startDate: new Date(),
      ...
      <Card className=" mx-auto">
        <CardHeader>
          ...
          <div className="flex justify-between items-center">
            ...
            <Badge
              variant={subscription.plan === "User" ? "secondary" : "default"}
      ...
      <Dialog open={isUpgradeDialogOpen} onOpenChange={setIsUpgradeDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Upgrade your plan to access more features and increase your gem
              allowance.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4">
        ...
        <DialogContent>
          ...
          <div className="py-4">
            ...
            <p className="mt-4 text-sm text-gray-500">
              If you change your mind, you can always subscribe again in the
              future.
            </p>
          </div>
          <DialogFooter>
